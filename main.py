...
await start_message.edit_text(
Data.START.format(msg.from_user.mention) +
"Checking status Ok... RAJASTHANI COME BACK **Bot Made BYℝ𝔸𝕁𝔸𝕊𝕋ℍ𝔸ℕ𝕀**🔍\n\n"
"Progress:[🟩🟩🟩🟩🟩🟩🟩🟩🟩] 100%\n\n"
)
...
cc = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\nTitle: {name1} @RAJASTHANI {res}.mkv\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦📖🇮🇳📖✦━━━━━**'
cc1 = f'**📁 PDF_ID: {str(count).zfill(3)}.\n\nTitle: {name1} @RAJASTHANI.pdf\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦📖🇮🇳📖✦━━━━━**'
